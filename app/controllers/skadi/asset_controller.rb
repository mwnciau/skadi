module Skadi
  ...
  class AssetController < ApplicationController
    # The status assets servered by this controller do not contain any sensitive information, so it is safe to skip forgery protection, allowing them to be loaded, e.g. via a <script> tag.
